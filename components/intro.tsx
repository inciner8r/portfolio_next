...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Punarv.</span> I'm a{" "}
        <span className="font-bold">full-stack developer</span>. I enjoy
        building, breaking and fixing <span className="font-mono">things</span>.
        Currently building around{" "}
        <span className="font-bold italic">Blockchain</span>.
      </motion.h1>
